...
| `descriptor`     | §2.6 TLV descriptors — registration / ISO-639 language / CA / video / audio / hierarchy / AVC / HEVC / data-stream-alignment / system-clock / multiplex-buffer-utilization / copyright / maximum-bitrate / smoothing-buffer / STD. |
